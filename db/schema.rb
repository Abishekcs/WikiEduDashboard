...
ActiveRecord::Schema[8.0].define(version: 2026_01_27_212149) do
  ...
  create_table "article_course_timeslices", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
  ...
  create_table "backups", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
  ...
  create_table "course_user_wiki_timeslices", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.integer "course_id", null: false
  ...
  create_table "course_wiki_timeslices", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.integer "course_id", null: false
    t.integer "wiki_id", null: false
    t.datetime "start"
    t.datetime "end"
  ...
  create_table "lti_contexts", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
  ...
  create_table "oauth_accounts", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "revision_ai_scores", charset: "utf8mb3", collation: "utf8mb3_general_ci", force: :cascade do |t|
